...
datadir  = '/global/cfs/cdirs/m1199/milena/EN4/climatologies'

climoyear1 = 2000
climoyear2 = 2014

modelfile = f'{modeldir}/{varname}_ensembleMean_{mm}_{climoyear1}_{climoyear2}.nc'
datafile = f'{datadir}/EN.4.2.2.f.analysis.c14_{mm}_{climoyear1}_{climoyear2}.nc'
