...
from make_plots import make_contourf_plot, make_pcolormesh_plot, make_scatter_plot
...
indirPHC = '/global/cfs/cdirs/e3sm/inputdata/ocn/mpas-o/ARRM10to60E2r1'
infilePHC = f'{indirPHC}/sss.PHC3.0_monthlyClimatology.ARRM10to60E2r1.220802.nc'
...
#for month in range(0, 1):
    sssPHC = dsPHC.surfaceSalinityMonthlyClimatologyValue.isel(Time=month)
    ...
    figTitle = f'PHC3 SSS on ARRM10to60 mesh (month={month+1:02d})'
    #figTitle = f'PHC3 Surface Salinity (month={month+1:02d})'
    figFile = f'./sssNH.PHC3.0_monthlyClimatology.ARRM10to60E2r1.220802_month{month+1:02d}.png'
    dotSize = 0.25
    make_scatter_plot(lonPHC, latPHC, dotSize, figTitle, figFile, projectionName='NorthPolarStereo',
                      lon0=-180, lon1=180, dlon=20, lat0=50, lat1=90, dlat=10,
                      fld=sssPHC, cmap=colormap, clevels=clevelsNH, cindices=colorIndices, cbarLabel='[psu]')
    ...
    #figFile = f'./sssSH.PHC3.0_monthlyClimatology.ARRM10to60E2r1.220802_month{month+1:02d}.png'
